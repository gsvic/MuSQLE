...
/**
  ...
  */
abstract class Vertex(val engines: Seq[(Engine, String)]) extends Comparable[Vertex] {
...
case class VertexImpl(override val engines: Seq[(Engine, String)]) extends Vertex(engines){
